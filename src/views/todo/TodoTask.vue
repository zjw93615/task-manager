        ...
        <div class="vx-row">
            <div class="vx-col w-full sm:w-5/6 flex sm:items-center sm:flex-row flex-col">
                <div class="flex items-center">
                    <vs-checkbox v-model="isCompleted" class="w-8 m-0 vs-checkbox-small" @click.native.stop />
...
<!--                </div>-->
        ...
        <div class="vx-row" v-if="taskLocal.description">
            <div class="vx-col w-full">
                <p class="mt-2 truncate" :class="{'line-through': taskLocal.isCompleted}">{{ taskLocal.description }}</p>
            </div>
        </div>
    </div>
</template>
